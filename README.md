...
Hebrew Support: Fully optimized for Right-to-Left (RTL) layouts and Hebrew localization.

Tech Stack
Frontend: Kotlin, MVVM Architecture, ViewBinding, Retrofit, Coil, Markwon.

Backend: FastAPI (Python), PostgreSQL, Groq Cloud API.
